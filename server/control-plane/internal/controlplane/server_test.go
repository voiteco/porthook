...
func TestDashboardEndpoint(t *testing.T) {
	...
	if !strings.Contains(body, "Reserved subdomains") || !strings.Contains(body, "Custom domains") || !strings.Contains(body, "Access policies") || !strings.Contains(body, "Active tunnels") || !strings.Contains(body, "Request logs") {
		t.Fatalf("body = %q, want dashboard reserved subdomains, custom domains, access policies, active tunnels, and request logs UI", body)
	}
