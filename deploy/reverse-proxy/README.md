...
See [../../docs/DOMAINS_TLS.md](../../docs/DOMAINS_TLS.md) for the full domain, wildcard DNS, and TLS guide. See [../../docs/ACCESS_BOUNDARY.md](../../docs/ACCESS_BOUNDARY.md) for control-plane and dashboard boundary guidance.
...
- [caddy/Caddyfile.control-allowlist](./caddy/Caddyfile.control-allowlist) adds a Caddy `remote_ip` allowlist to the control-plane hostname.
...
Do not expose the control-plane/dashboard hostname without a separate access boundary such as a private network, VPN, reverse-proxy authentication, SSO, mutual TLS, or an allowlist.
